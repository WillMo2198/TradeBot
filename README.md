...
# 📈 Using Watchdog to Buy and Sell Stocks

Watchdog does **not enforce a specific strategy**, but it provides the
infrastructure needed to place trades once your logic decides to do so.

Typical pipeline:

Market Data → Metrics → Signals → Risk Filters → Position Size → Order
Execution
